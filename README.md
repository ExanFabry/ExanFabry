...
- 🔭 I'm currently working on an exciting project where I'm building a complete website from the ground up for my own band. This project allows me to combine my passion for music with my technical skills. The website is being developed using HTML (EJS) for templating, CSS for styling, TypeScript for adding robust functionality, and MySQL to manage and store the backend data. Besides that I am currently developing my own API with C# ASP.NET as my backend and SQL as my database. I am also developing a project in C# where I create an aplication with test driven development for this project I am using NUnit for testing.
